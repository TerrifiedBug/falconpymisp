...
def build_feed_event(indicator_type: str, org_uuid: str, tlp_tag: str, distribution: int = 0) -> MISPEvent:
    event = MISPEvent()
...
def build_indicator_attribute(indicator: CSIndicator, tags_config) -> Optional[MISPAttribute]:
...
def build_report_event(report: CSReport, org_uuid: str, tlp_tag: str, distribution: int = 0) -> MISPEvent:
    event = MISPEvent()
...
def build_actor_event(actor: CSActor, org_uuid: str, tlp_tag: str, distribution: int = 0) -> MISPEvent:
    event = MISPEvent()
